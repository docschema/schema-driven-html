...
- Changed the default delimiter for `data-semantic-examples` (and `semantic-examples` meta tag) from semicolon (`;`) to comma (`,`). Custom delimiters can still be set via `<meta name="semantic:examples-delimiter" content="..." />`.
